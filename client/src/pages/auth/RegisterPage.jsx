...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute bottom-1/4 -left-32 w-96 h-96 bg-violet-600/20 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="w-full max-w-md bg-slate-900/80 backdrop-blur-xl border border-slate-800 rounded-2xl p-8 shadow-2xl relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 text-sm mt-1">Get started with FlowForge today</p>
        </div>
